...
import { SettingsSenecaClientV1 } from '../version1/SettingsSenecaClientV1';
...
export class SettingsClientFactory extends Factory {
	...
	public static SenecaClientV1Descriptor = new Descriptor('pip-services-settings', 'client', 'seneca', 'default', '1.0');
	...
	constructor() {
		...
		this.registerAsType(SettingsClientFactory.SenecaClientV1Descriptor, SettingsSenecaClientV1);
	}
