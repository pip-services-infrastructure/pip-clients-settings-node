...
class SettingsDirectClientV1 extends pip_services_rpc_node_1.DirectClient {
    constructor() {
        super();
        this._dependencyResolver.put('controller', new pip_services_commons_node_1.Descriptor("pip-services-settings", "controller", "*", "*", "*"));
    }
